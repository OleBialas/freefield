...
if "win" in platform:
    ...
    print("#######You seem to not be running windows as your OS. Working with TDT devices is only supported on "
          "windows!#######")
...
def initialize_devices(ZBus=True, RX81_file=None, RX82_file=None, RP2_file=None, RX8_file=None, cam=False,
    ...
    if RX81_file: RX81 = _initialize_processor(device_type='RX8', rcx_file=str(RX81_file), index=1,
                                               connection=connection)
    if RX82_file: RX82 = _initialize_processor(device_type='RX8', rcx_file=str(RX82_file), index=2,
                                               connection=connection)
